...
2)))
        ...
        val textView = onView(
allOf(withText("Detalle de Album"),
...
allOf(withText("Nombre del album"),
withParent(withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))),
isDisplayed()))
        textView2.check(matches(withText("Nombre del album")))
        
        val textView3 = onView(
allOf(withText("Genero"),
withParent(withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))),
isDisplayed()))
        textView3.check(matches(withText("Genero")))
        
        val textView4 = onView(
allOf(withText("Fecha de lanzamiento"),
withParent(withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))),
isDisplayed()))
        textView4.check(matches(withText("Fecha de lanzamiento")))
        
        val textView5 = onView(
allOf(withText("Descripción"),
withParent(withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))),
isDisplayed()))
        textView5.check(matches(withText("Descripción")))
        
        val textView6 = onView(
allOf(withText("Record Label"),
withParent(withParent(IsInstanceOf.instanceOf(android.widget.ScrollView::class.java))),
isDisplayed()))
